...
namespace FurnitureRetail.Data.Migrations
{
    ...
    [Migration("20240401094357_AddProductsTableData")]
    partial class AddProductsTableData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurnitureRetail.Core.Products", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("66030eef-7f80-4ec7-b5f1-f1e1d504ce32"),
                            Name = "Canapea Rosie",
                            Price = 2010.0
                        },
                        new
                        {
                            Id = new Guid("9038322a-776f-4583-acf7-7ecde2338d08"),
                            Name = "Scaun piele",
                            Price = 600.0
                        },
                        new
                        {
                            Id = new Guid("9333660b-e2e0-4431-a52a-dfc09d9e64cc"),
                            Name = "Scaun birou",
                            Price = 400.0
                        },
                        new
                        {
                            Id = new Guid("7fc67451-3d9d-4c1a-b703-ce4bf29bfb2c"),
                            Name = "Mobile living moderna",
                            Price = 2220.0
                        },
                        new
                        {
                            Id = new Guid("ce2cc3b5-f18f-41a6-b480-7659dbe1fefc"),
                            Name = "Canapea Rosie",
                            Price = 1200.0
                        },
                        new
                        {
                            Id = new Guid("c989b33c-0d57-41f5-b97a-8b8a23c2ba4c"),
                            Name = "Canapea Rosie",
                            Price = 2010.0
                        },
                        new
                        {
                            Id = new Guid("0a94fb53-a659-4bc8-807b-19e94f4e5358"),
                            Name = "Canapea Rosie",
                            Price = 2010.0
                        });
                });
